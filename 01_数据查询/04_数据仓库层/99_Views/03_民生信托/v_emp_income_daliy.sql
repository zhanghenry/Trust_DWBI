create or replace view v_emp_income_daliy as
with temp_main as
 (select distinct b.l_dayid as l_day_id, a.l_object_id,a.l_proj_Id, a.l_divide_id as l_stage_id
   ...
   where a.c_scheme_type = 'QC'
     ...
     and substr(a.l_begdiv_date,1,4) <= b.year_id
     and substr(a.l_enddiv_date,1,4) >= b.year_id
...
select a.l_day_id,
       ...
       (case when b.l_setup_date < substr(a.l_day_id,1,4)||'0101' then '´æÐø' when b.l_setup_date >= substr(a.l_day_id,1,4)||'0101' then 'ÐÂÔö' else null end) as c_status_name,
...
/* and e.l_effective_date <= a.l_day_id
   ...
   /*and a.l_day_id = 20161231*/
   and d.c_Busi_Scope in (1, 2)
  /* and a.l_object_id = 1409 and a.l_day_id = 20161231*/;
